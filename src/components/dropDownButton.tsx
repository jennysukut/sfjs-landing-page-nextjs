...
const DropDownButton: React.FC<ButtonProps> = ({
  ...
  const buttonClasses = clsx(
    "SiteButton relative z-[1] w-[22rem] cursor-pointer leading-6 font-semibold transition-all duration-150 tracking-superwide hover:saturate-[120%] px-8 py-4 text-[0.85rem]",
    {
      // isSelected
  ...
  const shadowClasses = clsx(
    "ButtonShadow absolute w-[22rem] text-transparent leading-6 font-semibold tracking-superwide text-[0.85rem] -right-2 top-2 px-8 py-4",
    {
      // isSelected
      "rounded-full": !isSelected,
