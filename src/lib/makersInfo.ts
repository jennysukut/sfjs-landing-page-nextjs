export const makersInfo = {
  ...
  "vinay gajjar": {
    firstName: "vinay",
    lastName: "gajjar",
    img: "bg-[url('/makers/vinay.svg')]",
    shadow: "bg-lime",
    details: [
      "Here are 7 Things I Love:",
      "Music. My taste is pretty varied, but my absolute favouite genres are Bhangra and UK Garage.",
      "Coffee. Chocolate. Pasta. Mac n Cheese is the ULTIMATE comfort food!!",
      "Puzzles. I've been doing Sudokos since my teen years, and I'm currently working through my second 1000 piece jigsaw puzzle!",
  ...
  "brittany prouser": {
    firstName: "brittany",
    lastName: "prouser",
    img: "bg-[url('/makers/brittany.svg')]",
    shadow: "bg-lilac",
    details: [],
  },
  "steven boutcher": {
  ...
  "jessica ford": {
    firstName: "jessica",
    lastName: "ford",
    img: "bg-[url('/makers/jessicaf.svg')]",
    shadow: "bg-jade",
    details: [],
  },
  "jessica d'apice": {
    firstName: "jessica",
    lastName: "d'apice",
    img: "bg-[url('/makers/jessicad.svg')]",
    shadow: "bg-orange",
    details: [
      "Passionate digital Agile team leader and business value deliverer in Life Sciences and Healthcare domains",
      "Ambassador between business and technology",
      "Lifelong learner",
      "Plant collector / Monstera Deliciosa propagator",
