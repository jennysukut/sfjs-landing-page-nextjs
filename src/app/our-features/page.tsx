...
export default function OurFeaturesPage() {
  ...
  return (
    <div
      className="LandingPageContainer -mb-24 -mt-48 flex h-[140vh] w-[100vw] max-w-[1600px] flex-col items-center justify-center"
      style={{
        backgroundImage: 'url("/BackgroundShapes8.svg")',
    ...
    >
      <div className="FeaturesPage flex w-[85%] max-w-[1600px] flex-col justify-center self-center">
        <div className="TopButtons flex justify-between">
          <button
            className="HumanFocusedTechSection items-middle font-mono -mt-20 ml-[15vw] flex gap-3 font-semibold"
